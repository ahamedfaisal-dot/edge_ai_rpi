...
> **Output videos and performance results from all pipeline stages running on Raspberry Pi 4 hardware are documented in the [`Output_in_PI4/`](.PI4-Output-for-Footage-Video) folder.**
